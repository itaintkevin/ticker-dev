        ...
        <div className="flex justify-between my-1">
          <div className='flex flex-col sm:flex-row justify-center sm:items-center'>
            ...
            <div className='flex'>
              ...
              <p className={`border-2 ${props.priority == "To Do" ? 'dark:border-green-300 border-green-300 hover:bg-green-300' : `${props.priority == "Doing" ? 'dark:border-yellow-300 border-yellow-300 hover:bg-yellow-300' : 'dark:border-red-400 border-red-400 hover:bg-red-400'}`}  transition duration-300 text-md rounded-md px-3 mx-1 h-max`}>
                {props.status}
              </p>
            </div>
          </div>
          <div>
            ...
            <button className={`${deleteTaskBtn ? 'dark:bg-neutral-600/30 bg-neutral-400' : 'dark:bg-neutral-200/20 bg-neutral-200'} hover:bg-neutral-400 transition duration-300 p-2 rounded-lg ml-2`} onClick={handleDeleteTaskBtn}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
